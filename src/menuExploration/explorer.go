	...
	for {
		...
		case 1:
			...
			case 1:
				...
				for !porteOuverte {
					...
					case 2:
						...
						fmt.Println("1.Ramasez-vous les 70 pièces ?")
						fmt.Println("2.Refusez-vous pas rammasser les 70 pièces")
						fmt.Scanln(&choix)
						switch choix {
						case 1:
							perso.Argent += 70
			...
			case 2:
				...
				fmt.Println()
				fmt.Println("1.Prenez-vous cette corde ?")
				fmt.Println("2.Refusez-vous cette corde ?")
				fmt.Scanln(&choix)
				switch choix{
				case 1:
